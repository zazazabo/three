...
//        Log.d("Sunset", "Sunset is: "+(int)(sunset/15+8)+":"+(int)(60*(sunset/15+8-(int)(sunset/15+8)))+" .\n");
    ...
    public static void main(String[] args) {
        String str1 = SunRiseSet.getSunrise(new BigDecimal(0110.2400), new BigDecimal(0021.1100), new Date());
        String str2 = SunRiseSet.getSunset(new BigDecimal(0110.2400), new BigDecimal(0021.1100), new Date());
