...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            ...
            if(this.options.toolbar == undefined) {
            	html.push(
            			...
            			sprintf('<input class="form-control' +
            					...
            					'" type="text" placeholder="%s" name="search">',
            					this.options.formatSearch()),
            	'</div>');
            } else {
            	if($(this.options.toolbar).attr('id') != undefined) {
            		if(/toolbar/.test($(this.options.toolbar).attr('id'))){
            		//if($(this.options.toolbar).attr('id').includes('toolbar')) {
            			html.push(
            					'<div class="pull-' + this.options.searchAlign + ' search">',
            					sprintf('<input class="form-control tabless' +
            							sprintf(' input-%s', this.options.iconSize) +
            							'" type="text" placeholder="%s" name="search">',
            							this.options.formatSearch()),
            			'</div>');
            ...
            this.$toolbar.append(html.join(''));
            $search = this.$toolbar.find('.search input[name=search]');
    ...
    BootstrapTable.prototype.checkBy = function (obj) {
        return this.checkBy_(true, obj);
    };

    BootstrapTable.prototype.uncheckBy = function (obj) {
        return this.checkBy_(false, obj);
    };
