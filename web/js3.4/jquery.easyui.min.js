...
$.fn.pagination.defaults={total:1,pageSize:20,pageNumber:1,pageList:[15,20,30,50,100],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_9f,_a0){
...
var _24d=$("<a href=\"###\"></a>").appendTo(_24c);
if(p.handler){
...
$("<a></a>").attr("href","###").text(_268).css("margin-left",10).bind("click",eval(_267[_268])).appendTo(tb).linkbutton();
}
}
...
var t=$("<a class=\"accordion-collapse accordion-expand\" href=\"###\"></a>").appendTo(_297.children("div.panel-tool"));
...
if(!t.length){
t=$("<a href=\"###\"></a>").addClass(_347).appendTo(tool);
...
},message:"Please enter a valid URL."},tel:{validator:function(_409){
return /^\d{11}$/i.test(_409);
},message:"Please enter a valid telnum."},length:{validator:function(_40a,_40b){
...
//$(_65c).html(_660.join("")); //IE6-9 Bugs
...
//$(_666).html(_669.join("")); //IE6-9 Bugs
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[15,20,30,50,100],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_695,_696){
...
if(type=="checked"){
return (_69c==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row>td>div.datagrid-cell-check>input:checked").parent().parent().parent();
...
var _899=$("<a href=\"###\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_898);
var _89a=$("<a href=\"###\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_898);
_899.click(function(){
...
var ok=$("<a href=\"###\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_8b3);
ok.click(function(){
_8b9(_8af);
});
}
...
(function($){
function init(_8ce){
var _8cf=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"###\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_8ce);
