                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="margin-left:10px;">
                                    <div id="slide_lamp_val"  class="easyui-slider"    data-options="showTip:true,rule:[0,'|',25,'|',50,'|',75,'|',100],min:0,max:100,step:1" style="width:150px"></div>
                                </span>
