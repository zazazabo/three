        ...
        <div class="contents">
            <div class="top">
                <ul class="secondMenu layui-nav">
                    <li name="static.jsp" class="layui-nav-item layui-this active"><a href="javascript:;">统计数据</a></li>
                    <li name="reportmanage.jsp" class="layui-nav-item"><a href="javascript:;">详细数据</a></li>
                    <li name="reportmanage.jsp" class="layui-nav-item"><a href="javascript:;">报警记录</a></li>
                    <li name="reportmanage.jsp" class="layui-nav-item"><a href="javascript:;">操作日志</a></li>
                    <span class="layui-nav-bar" style="width: 0px; left: 484px; opacity: 0; top: 45px;"></span></ul>
            </div>
            <div  id="content-main" style="height: 878px;">
                <iframe class="J_iframe" name="iframe0" src="static.jsp" data-id="index_v1.html" seamless="" width="100%" height="100%" frameborder="0"></iframe>
            </div>
        </div>
