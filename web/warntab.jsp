        ...
        <div class="contents">
            <div class="top">
                <ul class="secondMenu layui-nav">
                    <li name="warnning.jsp" class="layui-nav-item layui-this active"><a href="javascript:;">报警设置</a></li>
                    <li name="warnanylize.jsp" class="layui-nav-item"><a href="javascript:;">节能分析设置</a></li>

                    
<!--                             <li name="warnning.jsp" class="layui-nav-item layui-this active"><a href="javascript:;">报警设置</a></li>
                    <li name="warnanylize.jsp" class="layui-nav-item layui-this active"><a href="javascript:;">节能分析设置</a></li>  -->
