                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="margin-left:10px;" name="xxx" id="93">日期</span>从&nbsp;
                                    <input id="dd" class="easyui-datebox" name="day1" data-options="formatter:myformatter,parser:myparser"></input>&emsp;到&emsp;
                                    <input id="dd1" class="easyui-datebox" name="day2" data-options="formatter:myformatter,parser:myparser"></input>
